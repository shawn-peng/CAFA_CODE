...
% ontname = '~/workspace/cafa4/annotations/ont_intersection_cafa2'
% ontname = '~/workspace/cafa3/annotations/ont_intersection_cafa2'
% ontname = '~/workspace/cafa4/annotations/ont_intersection_cafa3'
gont.BPO = pfp_loadont([ontname, '_bpo.txt'],[ontname, '_bpo_rel.txt']);
gont.CCO = pfp_loadont([ontname, '_cco.txt'],[ontname, '_cco_rel.txt']);
gont.MFO = pfp_loadont([ontname, '_mfo.txt'],[ontname, '_mfo_rel.txt']);
