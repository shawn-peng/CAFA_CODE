...
% run('~/workspace/cafa2/config_cafa4.m')
run('~/workspace/cafa3/config_cafa4.m')
% run('~/workspace/cafa4/config_cafa43.m')
...
cafa_driver_eval([cfgdir, 'eval/regular/mfo_all_typex_mode1.job'])
cafa_driver_eval([cfgdir, 'eval/regular/bpo_all_typex_mode1.job'])
cafa_driver_eval([cfgdir, 'eval/regular/cco_all_typex_mode1.job'])
...
cafa_driver_result([evaldir, 'mfo_all_typex_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
cafa_driver_result([evaldir, 'bpo_all_typex_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
cafa_driver_result([evaldir, 'cco_all_typex_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
...
for i = 1:size(species)
    cafa_driver_eval([cfgdir, 'eval/regular/mfo_', species{i}, '_type1_mode1.job']);
	cafa_driver_result([evaldir, 'mfo_', species{i}, '_type1_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
	
    cafa_driver_eval([cfgdir, 'eval/regular/bpo_', species{i}, '_type1_mode1.job']);
	cafa_driver_result([evaldir, 'bpo_', species{i}, '_type1_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
	
    cafa_driver_eval([cfgdir, 'eval/regular/cco_', species{i}, '_type1_mode1.job']);
	cafa_driver_result([evaldir, 'cco_', species{i}, '_type1_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
	
    cafa_driver_eval([cfgdir, 'eval/regular/mfo_', species{i}, '_type2_mode1.job']);
	cafa_driver_result([evaldir, 'mfo_', species{i}, '_type2_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
	
    cafa_driver_eval([cfgdir, 'eval/regular/bpo_', species{i}, '_type2_mode1.job']);
	cafa_driver_result([evaldir, 'bpo_', species{i}, '_type2_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
	
    cafa_driver_eval([cfgdir, 'eval/regular/cco_', species{i}, '_type2_mode1.job']);
	cafa_driver_result([evaldir, 'cco_', species{i}, '_type2_mode1/'], [cfgdir, 'register.tab'], 'BN4S', 'BB4S', 'all')
end
